<?php
if (isset($_REQUEST['codanimal']) && isset($_REQUEST['editar'])) {
...
<form action="../../../back-end/controladores/Animal_controladores.php"  method="post" enctype="multipart/form-data" class="needs-validation" novalidate>
  ...
  <div class="form-row">
    ...
    <div class="col-md-6 mb-3">
      ...
      <input type="text" class="form-control" name="nombreanimal" id="validationCustom02" maxlength="20" pattern="[A-Z  a-z]{1,20}"  
      value="<?php echo $ani->nombreanimal?>" required>
      <div class="valid-feedback">
      ¡Se ve bien!
      </div>
    </div>
  ...
  <div class="form-row">
    <div class="col-md-6 mb-3">
      ...
      <input type="number" class="form-control" name="id_Habitat" id="validationCustom02" 
      value="<?php echo $ani->id_Habitat?>" required>
    ...
    <div class="col-md-3 mb-3">
      ...
      <select class="custom-select" id="validationCustom02" name="dieta"  value="<?php echo $ani->dieta?>" required>
      ...
      ¡Se ve bien!
       ...
       <div class="col-md-2 mb-3">
        <input type="hidden" name="foto_actual" value="<?php echo $ani->foto  ?>" >
        <img src="../../back-end/images/animales/<?php echo $ani->foto  ?>" alt="foto de animales" width="150" height="150">
